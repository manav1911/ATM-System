#include<conio.h> //We use this header to use the function getch, this functions holds the screen until the user presses any key
#include<iostream>
#include<string>
using namespace std;
...
int main()
{
	...
	system("cls");        //This function helps to clear the screen after moving from one menu to another
	...
	do
	{
		...
		cout << endl << "****Welcome to our ATM Services*****" << endl;
		cout << endl << "Enter Your Account Number: ";	  // asking user to enter account no
		cin >> enterAccountNo;
		...
		if ((enterAccountNo == user1.getAccountNo()) && (enterPIN == user1.getPIN()))
		{
			do
			{
				...
				case 3:										// if user presses 3
					...
					cout << endl << "-> Mobile Nunmber: " << user1.getMobileNo();
